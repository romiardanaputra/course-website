...
function AdminDashboard() {
  return (
    <div className='h-screen py-[5rem]'>
      {/* title content */}

      {/* left sidebar in desktop mode */}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              ...
              <Link to="https://flowbite.com" className="flex ml-2 md:mr-24">
                ...
                <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Code Furious</span>
              </Link>
            </div>
              ...
              <div className="flex items-center ml-3">
                <div>
                  <button type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                    ...
                    <img className="w-8 h-8 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt='logobutton' />
                  </button>
                </div>
      ...
      {/* manage course */}
      {/* <div  className="py-5 grid gap-5 md:grid-cols-2 lg:grid-cols-4 ">
          <div  className="course-management">
            <CardComponent title={'Course'} altTitle={'manage all courses'} manage={'Manage'} view={'View'} image={image1}></CardComponent>
          </div>
          <div  className="user-management">
            <CardComponent title={'User'} altTitle={'manage all user'} manage={'Manage'} view={'View'} image={image2}></CardComponent>
          </div>
        </div> */}
    </div>
  )
