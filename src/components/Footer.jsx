...
function Footer() {
    return (
        <div className="py-28 bg-[#746D69] leading-relaxed">
            <footer className="p-4 sm:p-6 dark:bg-gray-900 container mx-auto">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link to="#" className="flex items-center">
                            <img src="https://flowbite.com/docs/images/logo.svg" className="h-8 mr-3" alt="FlowBite Logo" />
                            <span className="self-center text-2xl font-semibold whitespace-nowrap text-slate-200 dark:text-white">Tolol Course</span>
                        </Link>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-slate-200 uppercase dark:text-white">Resources</h2>
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-slate-200 uppercase dark:text-white">Follow us</h2>
                            <ul className="text-slate-300 dark:text-gray-400">
                                <li className="mb-4">
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-slate-200 uppercase dark:text-white">Legal</h2>
                            <ul className="text-slate-300 dark:text-gray-400">
                                <li className="mb-4">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-slate-200 sm:text-center dark:text-gray-400">© 2023 <Link to="https://flowbite.com/" className="hover:underline">Flowbite™</Link>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <Link to="#" className="text-slate-200 hover:text-slate-50 dark:hover:text-white">
